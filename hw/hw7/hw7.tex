...
\begin{enumerate}
	...
	\begin{itemize}
		\item For each of the considerations you generated above in Deliberate Practice: Prioritizing Information, assess the sensitivity of your forecast to uncertainty in these considerations.
		\item Based on this, create an 80\% confidence interval around your original point estimate.   
	\end{itemize}
	
	\item Combine the two sources of uncertainty into a final 80\% confidence interval for the forecast question.
	\item Write up the following in your Gradescope submission:
	\begin{itemize}
		\item Considerations you generated for structural uncertainty.
		\item How you quantified the structural and numerical uncertainty.
		\item Your 80\% confidence intervals for each source of uncertainty, and your final confidence interval.
		\item Reflections on this exercise -- were there certain prompts that helped you to think of new sources of structural uncertainty? Does your final confidence interval feel wider or narrower than one you would have come up with, using just a ``gut" feeling? Other reflections?
	\end{itemize}
	\end{enumerate}
